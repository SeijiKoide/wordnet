;; -*- lisp-version: "8.2 [64-bit Linux (x86-64)] (Aug 25, 2013 6:18)"; cg: "1.134"; -*-

(in-package :cg-user)

(define-project :name :WordNet30
  :modules (list (make-instance 'module :name "make-rdf-files/package")
                 (make-instance 'module :name "make-rdf-files/utilmacro")
                 (make-instance 'module :name "make-rdf-files/Utils")
                 (make-instance 'module :name "make-rdf-files/WordNet")
                 (make-instance 'module :name "make-rdf-files/WordNet20")
                 (make-instance 'module :name "make-rdf-files/WordNet21")
                 (make-instance 'module :name "make-rdf-files/WordNet30")
                 (make-instance 'module :name "make-rdf-files/make-rdf-files"))
  :projects nil
  :libraries nil
  :editable-files nil
